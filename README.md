...
Versione standalone pronta per GitHub Pages.

## Caricamento su GitHub

Carica nella root del repository solo questi file:

- `index.html`
- `README.md`

Poi vai su `Settings > Pages` e scegli:

- Source: `Deploy from a branch`
- Branch: `main`
- Folder: `/root`

Il sito deve aprirsi dall'URL del repository oppure da `/index.html`.
